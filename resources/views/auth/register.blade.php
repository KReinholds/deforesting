    ...
    <div class="w-full sm:max-w-3xl px-6 py-4 mx-auto">
        ...
        <div class="flex flex-row justify-around items-center">
            <div class="">
              ...
              <label for="individual" class="text-base text-degreenlight uppercase">
                  Fiziska persona
              </label>
      </div>
          <div>
         ...
         onchange="if(this.clicked) window.location.href='/register/company';">

  <label for="company"
         class="text-base text-degreen uppercase cursor-pointer"
      ...
      Juridiska persona
        ...
        <form method="POST" action="{{ route('register.individual') }}" class="max-w-4xl mx-auto p-6 bg-white   space-y-6">
            ...
            <div class="flex flex-col gap-2">
                  <div>
                    <input type="checkbox" id="terms" name="gdpr" required class="rounded border-degreen text-degreen focus:outline-none focus:ring-0">
